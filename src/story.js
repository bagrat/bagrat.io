export default [
  {
    ...
    paragraphs: [
      ...
      'Since the website is intended to demonstrate <em>"a proven interest in computer science from a young age"</em>, it tells a story back from when Bagrat had his initial encounters with actual computers, since his arguably conscious stage of life. While the next 15 minutes may possibly be the most boring 50 minutes of your life, still, please bear with me...<strike>or panda with me.</strike>',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      'Over time, patterns emerged in Bagrat\'s mind, motivating him to get a hand or two dirty. With his very basic knowledge of Basic and an idea from the future informatics teacher he wrote a program for the school that would speak out an <a href="https://en.wikipedia.org/wiki/Armenian_language">Armenian</a> word and expect it to be written into a textbox to be spellchecked.',
      'This won him a waiver from the upcoming Pascal classes in the 8th grade. So he used this free time to learn C/C++ to later be used in programming olympiads.',
      'Before starting the 8th grade, Bagrat spent the summer working in a local electronics store, assembling hundreds of desktop PCs. One day he attempted to insert the RAM into the motherboard the other way around, and feeling resistance he applied more force onto it. The result was broken RAM and motherboard socket.',
  ...
  {
    title: "Top-Down",
    image: "/top-down-480.gif",
    paragraphs: [
      'The passion for programming gave Bagrat some popularity among his more academically-inclined peers. This led to a class-mate referring Bagrat to her uncle, running a local business developing a proprietary wireless transceiver, who was looking for cheap labor, otherwise called interns.',
      'At his 18, Bagrat got this job where he initially used C# to develop a GUI application to tweak the configuration of the transceiver. He then gradually moved more towards the transceiver side, writing C code on <a href="https://en.wikipedia.org/wiki/AVR32">AVR32 microcontrollers</a>.',
      'As one of his major projects he integrated a 3rd-party Wi-Fi chip onto the modem as a wireless alternative to <a href="https://en.wikipedia.org/wiki/RS-232">RS-232</a> for data transmission and configuration. While this might sound fancy, it was essentially calling the right custom functions from inside the right Wi-Fi library callbacks. But the important side of this is that it required Bagrat to learn and understand the <a href="https://en.wikipedia.org/wiki/OSI_model">OSI model</a>.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'At his next job, the requirements gathering for e-commerce and government apps were going pretty slowly, which was giving Bagrat a lot of free time to learn and experiment with continuous integration, write shell scripts for deployment and take number of online courses, one of which was the famous <em>Stanford Machine Learning course by Andrew Ng</em>.',
    ],
  },
  {
    title: 'Thinking in Systems',
    subtitle: '<a href="https://www.amazon.com/Thinking-Systems-Donella-H-Meadows/dp/1603580557">© Donella Meadows</a>',
  ...
  {
    title: "λ",
    subtitle: '(no, this does not mean Half-Life)',
    image: "/lambda-480.gif",
    paragraphs: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Here he witnessed how catastrophically off could naming of domain concepts ever be done. The least problem of it was that discussions during meetings would not make any sense to a person new to it all. But the worst part was that when you start to make sense, it would erode your thinking so badly that you would be caught in the trap of not being able to produce any new sensible work going forwards.',
